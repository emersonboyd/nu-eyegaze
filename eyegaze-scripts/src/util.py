...
def get_angle_audio_file(angle_float):
        ...
        if angle_float >= -55 and angle_float < -45:
                return '10oclock.mp3'
        elif angle_float >= -45 and angle_float < -15:
                return '11oclock.mp3'
        elif angle_float >= -15 and angle_float < 15:
                return 'straightahead.mp3'
        elif angle_float >= 15 and angle_float < 45:
                return '1oclock.mp3'
        elif angle_float >= 45 and angle_float < 55:
                return '2oclock.mp3'
